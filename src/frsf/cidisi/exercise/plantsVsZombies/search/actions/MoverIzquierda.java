...
public class MoverIzquierda extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        else if (plantsState.getmatrizPosition(row, col) == PercepcionPlanta.PERCEPCION_VACIO)
        {
        	...
        	{
        		if((col==0) 
        				&& plantsState.getmatrizPosition(row, col) == PercepcionPlanta.PERCEPCION_VACIO 
    ...
    public EnvironmentState execute(AgentState ast, EnvironmentState est) {
    	...
    	if(col < 8) {
    		...
    		if(plantsState.getmatrizPosition(row, col) == PercepcionPlanta.PERCEPCION_VACIO && plantsState.getCantidadSol()>1)
    		{
    			if(col==0)
    			{
    				int valor = plantsState.numeroRandomGirasol();
                	...
                	plantsState.setmatrizPosition(row, col, valor+5);
                	environmentState.setCantidadSoles(plantsState.getCantidadSol());
                	environmentState.setMatriz(row, col, valor);
