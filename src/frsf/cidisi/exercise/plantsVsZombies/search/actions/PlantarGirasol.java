...
public class PlantarGirasol extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        if(col == 0 && plantsState.getmatrizPosition(row, col) == PercepcionPlanta.PERCEPCION_VACIO && plantsState.getCantidadSol()>1)
        {       	
        	...
        	plantsState.setContadorPlanta(plantsState.getContadorPlanta()+1);
    ...
    public EnvironmentState execute(AgentState ast, EnvironmentState est) {
        ...
        {       	
        	...
        	plantsState.setmatrizPosition(row, col, PercepcionPlanta.PERCEPCION_GIRASOL);
        	plantsState.setContadorPlanta(plantsState.getContadorPlanta()+1);
        	environmentState.setContadorPlanta(plantsState.getContadorPlanta());
